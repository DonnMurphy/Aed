...
public class ViewDeck extends AppCompatActivity {
 ...
 //       eth.connectToEthNetwork();
        ...
        // Initialize cards
          ...
          RestUtils.getInstance(getApplicationContext()).getSheepByOwner(userId, new SheepRestListener<ArrayList<Sheep>>() {
            ...
            public void getResult(ArrayList<Sheep> Object) {
                sheeps = Object;
                if(sheeps.isEmpty()){
                    setContentView(R.layout.empty_deck_layout);
                    btnOpenAuctionHouse = findViewById(R.id.btnOpenAuctionHouse);
                    btnOpenScan = findViewById(R.id.btnStartScan);

                    btnOpenAuctionHouse.setOnClickListener(new View.OnClickListener() {
                        @Override
                    ...
                    btnOpenScan.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent K = new Intent(getApplicationContext(),ScanMenu.class);
                            K.putExtra("is_transfer",false);
                            startActivity(K);
                        }
                    });
        ...
        BottomNavigationView bottomNavigationView = (BottomNavigationView) findViewById(R.id.bottom_navigation);
        bottomNavigationView.setSelectedItemId(R.id.action_view_deck);
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
